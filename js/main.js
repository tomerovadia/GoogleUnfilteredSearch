...
svg.selectAll('g')
  ...
  .enter()
  .append('g')
  .attr('x', (d, i) => lonScale(d.lon))
  .attr('y', (d, i) => latScale(d.lat))
  .append('circle')
  .attr('cx', (d, i) => lonScale(d.lon))
  .attr('cy', (d, i) => latScale(d.lat))
...
svg.selectAll('g')
  .append('text')
  .attr('x', (d, i) => lonScale(d.lon) - 9 )
  .attr('y', (d, i) => latScale(d.lat) + 5 )
  .text((d) => d.name)
