...
var PanelFunctions = __webpack_require__(6);
...
var undimSVG = function undimSVG() {
...
var fetchInterestByRegionAndUpdate = function fetchInterestByRegionAndUpdate(keyword) {
  return ApiUtil.fetchInterestByRegion(keyword).then(function (results) {
...
var applyXYForces = function applyXYForces(simulation, xScale, yScale, xFactor, yFactor) {
  simulation.force('x', d3.forceX(function (d) {
    return xScale(d[xFactor]);
  }).strength(0.4)).force('y', d3.forceY(function (d) {
    return yScale(d[yFactor]);
  }).strength(0.4));
};
...
exports.createCirclesSimulation = function (svg, data, factors) {
  ...
  var simulation = simulation || d3.forceSimulation();
...
exports.renderRelatedQueries = function (data) {
  ...
  // Enter
  selection.enter().append('span').attr('class', 'related-queries-span').html(function (d) {
    return d[0] + ' &#9679; ' + d[1];
  ...
  var relatedQueriesSpans = d3.selectAll('.related-queries-span');
...
exports.activatePanelListeners = function () {
